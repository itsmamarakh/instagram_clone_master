            ...
            <div className="flex items-center border justify-between relative">
                ...
                {emoji && (
                    <div className="absolute bg-white max-h-sm border rounded"
                        style={{bottom: "40px"}}
                    >
                        <div className="emojiCon grid overflow-auto grid-cols-1 p-3">
                            {EMOJISCHAR.map(emoji => (
                                <div
                                    className="hover:emojiBor p-1 cursor-pointer"
                ...
                <div>
                    <button
                        className="text-purple-500 border-2 text-sm font-bold text-sm rounded-xl text-purple w-14 h-8"
                        onClick={addComment}
                    >
                    send
                    </button>
